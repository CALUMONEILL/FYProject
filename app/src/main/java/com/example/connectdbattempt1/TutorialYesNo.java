...
public class TutorialYesNo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutorial_yesno);
        ...
        btnNext3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                txtInfo2.setText("Now, click either Yes or No");
        ...
        btnNext4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                txtInfo2.setText("Click next to continue to the next section");

                countNext++;

                if (countNext == 2) {
                    Intent intent = new Intent(getApplicationContext(), TutorialConfidence.class);
        ...
        btnYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                txtInfo2.setText("As you would progress through the test, you can select Yes or No depending on what you can hear");
